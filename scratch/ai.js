...
// AI
  var aiPac = function () {
    if (
      (($('.11').find('img').length === 1)&&($('.12').find('img').length === 1)) 
      || (($('.31').find('img').length === 1)&&($('.22').find('img').length === 1)) 
      || (($('.23').find('img').length === 1)&&($('.33').find('img').length === 1)) 
      ) 
    {
      $('.13').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else if (
      (($('.12').find('img').length === 1)&&($('.13').find('img').length === 1)) 
      || (($('.22').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      || (($('.21').find('img').length === 1)&&($('.31').find('img').length === 1)) 
      )
    {
      $('.11').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else if (
      (($('.11').find('img').length === 1)&&($('.21').find('img').length === 1)) 
      || (($('.22').find('img').length === 1)&&($('.13').find('img').length === 1)) 
      || (($('.32').find('img').length === 1)&&($('.33').find('img').length === 1)) 
      )
    {
      $('.31').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else if (
      (($('.11').find('img').length === 1)&&($('.31').find('img').length === 1)) 
      || (($('.22').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      )
    {
      $('.21').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else if (
      (($('.12').find('img').length === 1)&&($('.32').find('img').length === 1)) 
      || (($('.21').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      )
    {
      $('.22').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else if (
      (($('.13').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      || (($('.21').find('img').length === 1)&&($('.22').find('img').length === 1)) 
      )
    {
      $('.23').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else if (
      (($('.11').find('img').length === 1)&&($('.13').find('img').length === 1)) 
      || (($('.22').find('img').length === 1)&&($('.32').find('img').length === 1)) 
      )
    {
      $('.12').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else if (
      (($('.12').find('img').length === 1)&&($('.22').find('img').length === 1)) 
      || (($('.31').find('img').length === 1)&&($('.33').find('img').length === 1)) 
      )
    {
      $('.32').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else if (
      (($('.31').find('img').length === 1)&&($('.32').find('img').length === 1)) 
      || (($('.13').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      )
    {
      $('.33').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
    } else {
        $('.row').each(function () {
          if ($(this).find("img").length === 0) {
            $(this, 'li').append('<img id="pac" src="./imgs/pac_stencil_small.jpg" />');
            return false;
          }
        });
      } 
  ...
  var aiBig = function () {
    ...
    {
      $('.13').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else if (
      (($('.12').find('img').length === 1)&&($('.13').find('img').length === 1)) 
      || (($('.22').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      || (($('.21').find('img').length === 1)&&($('.31').find('img').length === 1)) 
    ...
    {
      $('.11').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else if (
      (($('.11').find('img').length === 1)&&($('.21').find('img').length === 1)) 
      || (($('.22').find('img').length === 1)&&($('.13').find('img').length === 1)) 
      || (($('.32').find('img').length === 1)&&($('.33').find('img').length === 1)) 
    ...
    {
      $('.31').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else if (
      (($('.11').find('img').length === 1)&&($('.31').find('img').length === 1)) 
      || (($('.22').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      )
    {
      $('.21').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else if (
      (($('.12').find('img').length === 1)&&($('.32').find('img').length === 1)) 
      || (($('.21').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      )
    {
      $('.22').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else if (
      (($('.13').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      || (($('.21').find('img').length === 1)&&($('.22').find('img').length === 1)) 
      )
    {
      $('.23').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else if (
      (($('.11').find('img').length === 1)&&($('.13').find('img').length === 1)) 
      || (($('.22').find('img').length === 1)&&($('.32').find('img').length === 1)) 
      )
    {
      $('.12').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else if (
      (($('.12').find('img').length === 1)&&($('.22').find('img').length === 1)) 
      || (($('.31').find('img').length === 1)&&($('.33').find('img').length === 1)) 
      )
    {
      $('.32').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else if (
      (($('.31').find('img').length === 1)&&($('.32').find('img').length === 1)) 
      || (($('.13').find('img').length === 1)&&($('.23').find('img').length === 1)) 
      )
    {
      $('.33').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
    } else {
        $('.row').each(function () {
          if ($(this).find("img").length === 0) {
            $(this, 'li').append('<img id="pac" src="./imgs/big_stencil_small.jpg" />');
            return false;
          }
        });
      } 
